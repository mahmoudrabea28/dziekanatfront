...
import Sylabusy from './pages/Sylabusy'
      ...
      <ToastProvider>
        ...
        <main className="page">
          <Routes>
            ...
            <Route path="/sylabusy" element={<RequireAuth><Sylabusy /></RequireAuth>} />
            <Route path="/edit/:id" element={<RequireAuth role="professor"><EditTitle /></RequireAuth>} />
