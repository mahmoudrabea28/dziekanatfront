...
export default function ReviewPage(){
  ...
  async function onSubmit(e){ e.preventDefault(); try{ await api.post('/reviews/'+id,{grade,comment,status}); localStorage.removeItem(LS_KEY); nav('/assigned') }catch(e){ setErr(e?.response?.data?.error || 'Failed to submit review') } }
